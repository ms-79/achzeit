        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-up" style={{ animationDelay: '0.2s' }}>
            <div className="aspect-[4/3] rounded-lg overflow-hidden shadow-medium border border-border/50">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21609.694834012716!2d10.252777!3d47.458611!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479c7f7e0b0d4c29%3A0x41e48add78be620!2sFischen%20im%20Allg%C3%A4u!5e0!3m2!1sen!2sde!4v1705000000000!5m2!1sen!2sde"
                className="w-full h-full"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Fischen im Allgäu Map"
              />
            </div>
          </div>
