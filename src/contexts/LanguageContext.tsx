...
const translations: Record<Language, Record<string, string>> = {
  de: {
   ...
   'hero.description': 'Wir haben ACHZEIT so gestaltet, wie wir selbst Urlaub machen möchten – ruhig, hochwertig und familienfreundlich.',
    ...
    'hero.sub': 'Dein modernes <strong>Family Retreat</strong> im Allgäu – mit privater Sauna, Kamin, Garten, Terrasse, Balkon und Platz für bis zu 7 Gäste.',
    'hero.facts': 'Bis 7 Gäste · 3 Schlafzimmer · 3 Bäder/WCs · private Sauna · Kamin · Garten · E-Ladestation',
    ...
    'hero.trust.compact': 'Direkt beim Gastgeber buchbar · persönlicher Kontakt · sichere Zahlung',
    ...
    'hero.book.title': 'Verfügbarkeit & Preis prüfen',
    'hero.book.intro': 'Wähle deinen Reisezeitraum und prüfe direkt, ob ACHZEIT verfügbar ist.',
   ...
   'hero.book.kids.short': 'Kinder',
    'hero.book.cta': 'Preis & Verfügbarkeit prüfen',
    'hero.book.trust': 'Sichere Direktbuchung beim Gastgeber',
  ...
  en: {
    ...
    'hero.sub': 'Your modern <strong>family retreat</strong> in the Allgäu – with private sauna, fireplace, garden, terrace, balcony and space for up to 7 guests.',
    'hero.facts': 'Up to 7 guests · 3 bedrooms · 3 bathrooms · private sauna · fireplace · garden · EV charger',
    ...
    'hero.book.title': 'Check availability & price',
    'hero.book.intro': 'Pick your travel dates and check ACHZEIT\u2019s availability instantly.',
    'hero.book.checkin': 'Check-in',
    'hero.book.checkout': 'Check-out',
   ...
   'hero.book.kids.short': 'children',
    'hero.book.cta': 'Check price & availability',
    'hero.book.trust': 'Secure direct booking with the host',
    'hero.trust.compact': 'Direct booking with host · personal contact · secure payment',
