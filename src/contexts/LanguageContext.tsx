...
const translations: Record<Language, Record<string, string>> = {
  de: {
   ...
   'hero.description': 'Wir haben ACHZEIT so gestaltet, wie wir selbst Urlaub machen möchten – ruhig, hochwertig und einladend für Familien wie Freunde.',
    ...
    'hero.sub': 'Modernes Ferienhaus in Fischen mit Sauna, Kamin und viel Platz – ideal für Familien, befreundete Paare und gemeinsame Auszeiten im Allgäu.',
    ...
    'hero.usp.capacity.sub': 'Bis zu 7 Gäste · bis zu 6 Erwachsene',
   ...
   'hero.book.kids.short': 'Kinder',
    ...
    'gallery.bedroom3': 'Schlafzimmer 3 – Etagenbett (90 × 200) & Einzelbett (80 × 180)',
    ...
    'gallery.bedroomsingle': 'Einzelbett (80 × 180 cm) in Schlafzimmer 3',
  ...
  en: {
    ...
    'hero.sub': 'Modern holiday home in Fischen with sauna, fireplace and plenty of space – ideal for families, couples and shared getaways in the Allgäu.',
    ...
    'hero.usp.capacity.sub': 'Up to 7 guests · up to 6 adults',
   ...
   'hero.book.kids.short': 'children',
    ...
    'gallery.bedroom3': 'Bedroom 3 – Bunk Bed (90 × 200) & Single Bed (80 × 180)',
    ...
    'gallery.bedroomsingle': 'Single Bed (80 × 180 cm) in Bedroom 3',
