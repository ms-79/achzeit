...
const translations: Record<Language, Record<string, string>> = {
  de: {
   ...
   'hero.description': 'Wir haben ACHZEIT so gestaltet, wie wir selbst Urlaub machen möchten – ruhig, hochwertig und familienfreundlich.',
    ...
    'hero.book.subtitle': 'Wähle deinen Reisezeitraum und prüfe direkt, ob ACHZEIT verfügbar ist.',
   ...
   'hero.book.kids.short': 'Kinder',
    ...
    // Trust bar
    'trust.favorite': 'Gäste-Favorit bei Airbnb',
    'trust.rating': '5,0 / 5 Sterne',
    'trust.reviews': '{count} Bewertungen',
    'trust.direct': 'Direkt beim Gastgeber buchbar',
    'trust.service': 'Persönlicher Kontakt · sichere Zahlung · klare Informationen',
  ...
  en: {
    ...
    'hero.facts': 'Up to 7 guests · 3 bedrooms · 3 baths/WCs · private sauna · fireplace · garden · EV charger',
    ...
    'hero.book.subtitle': 'Pick your travel dates and instantly see if ACHZEIT is available.',
    'hero.book.checkin': 'Check-in',
    'hero.book.checkout': 'Check-out',
   ...
   'hero.book.kids.short': 'children',
    ...
    'hero.book.trust': 'Secure direct booking with your host.',

    // Trust bar
    'trust.favorite': 'Guest favorite on Airbnb',
    'trust.rating': '5.0 / 5 stars',
    'trust.reviews': '{count} reviews',
    'trust.direct': 'Book directly with the host',
    'trust.service': 'Personal contact · secure payment · clear information',
