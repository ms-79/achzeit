...
const translations: Record<Language, Record<string, string>> = {
  de: {
   ...
   'hero.description': 'Wir haben ACHZEIT so gestaltet, wie wir selbst Urlaub machen möchten – ruhig, hochwertig und einladend für Familien wie Freunde.',
    ...
    'hero.headline.1': 'ACHZEIT – Eure Auszeit zwischen Bergen & Wäldern',
    ...
    'hero.usp.sauna.sub': 'Entspannung nach einem langen Bergtag',
    'hero.usp.fireplace.title': 'Kamin',
    'hero.usp.fireplace.sub': 'Gemütliche Abende mit Familie und Freunden',
    'hero.usp.grill.title': 'Outdoor-Grill',
    'hero.usp.grill.sub': 'Gemeinsames Grillen auf der Terrasse',
   ...
   'hero.book.kids.short': 'Kinder',
    ...
    'gallery.workspace': 'Arbeitsbereich direkt an Schlafzimmer 1',
    'gallery.balconyview': 'Blick vom Balkon auf die Allgäuer Berge',
    'gallery.laundry': 'Waschbereich mit Waschmaschine und Trockner',
    'gallery.bathrooms': 'Badezimmer en Suite (Schlafzimmer 1)',
    'gallery.showerbed1': 'Bad mit Dusche an Schlafzimmer 1',
  ...
  en: {
    ...
    'hero.headline.1': 'ACHZEIT – Your getaway between mountains & forests',
    ...
    'hero.usp.sauna.title': 'Private Sauna',
    'hero.usp.sauna.sub': 'Relax after a long day in the mountains',
    'hero.usp.fireplace.title': 'Fireplace',
    'hero.usp.fireplace.sub': 'Cozy evenings with family and friends',
    'hero.usp.grill.title': 'Outdoor grill',
    'hero.usp.grill.sub': 'Grilling together on the terrace',
   ...
   'hero.book.kids.short': 'children',
    ...
    'gallery.workspace': 'Workspace next to bedroom 1',
    'gallery.balconyview': 'View from the balcony over the Allgäu mountains',
    'gallery.laundry': 'Utility area with washer and dryer',
    'gallery.bathrooms': 'En Suite Bathroom (Bedroom 1)',
    'gallery.showerbed1': 'Bathroom with shower at bedroom 1',
    'gallery.sauna': 'Private Sauna',
